...
class SchedulerActor:
    ...
    def __init__(
        ...
        # Publish the resolved config at actor entry: this process constructs
        # Scheduler directly (no run_scheduler_process), and Scheduler.__init__
        # reads the config namespaces before the model worker's own publish.
